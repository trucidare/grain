...
describe("numbers", ({test, testSkip}) => {
  ...
  assertRun(
    "nan_equality1",
    {|include "float32" as Float32; print(Float32.div(0.0f, 0.0f) == Float32.div(0.0f, 0.0f))|},
    "false\n",
  );
  assertRun(
    "nan_equality2",
    {|include "float64" as Float64; print(Float64.div(0.0d, 0.0d) == Float64.div(0.0d, 0.0d))|},
    "false\n",
  );
